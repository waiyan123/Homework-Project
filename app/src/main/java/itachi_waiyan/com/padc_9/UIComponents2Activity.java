...
public class UIComponents2Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Button btnClickAssignment = findViewById(R.id.btn_click_to_assignment_layout);
        btnClickAssignment.setOnClickListener(this);
...
//        });
    ...
    public void onClick(View view) {
        startActivity(Assignment1.newIntent(this,"this is a test"));
    }
}